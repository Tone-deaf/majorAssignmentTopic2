...
class albumTest {
    ...
    void testDisplaySongs() {
        ...
        // Optionally print the songs (in practice, you would need to capture console output to assert this)
        album.displaySongs();  // This will print the songs, but can't easily assert the printout without capturing it
    }
}